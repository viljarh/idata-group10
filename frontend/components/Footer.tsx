...
//Fetched from https://v0.dev/t/uWfTubiZ3UM
    ...
    <div className="text-white py-8">
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between">
        <div className="flex items-center space-x-4">
          <Link className="text-white hover:text-gray-300" href="https://github.com/viljarh/idata-group10">
            <GitHubLogoIcon className="h-6 w-6 text-black dark:text-white" />
            <span className="sr-only">GitHub</span>
          </Link>
          <Link className="text-white hover:text-gray-300" href="https://twitter.com/chucknorrisjoke">
